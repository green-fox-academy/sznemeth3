...
public class Triangles {
    ...
    public static void mainDraw(Graphics graphics){
        ...
        for (int i = 1; i < 21; i+=1) {
            graphics.drawLine((int)0+(i*TRIANGLE_SIDE/21),TRIANGLE_BOTTOMY,(int)0+i*TRIANGLE_SIDE/42,
                    (int)TRIANGLE_BOTTOMY- (int)(i*(TRIANGLE_HEIGHT/21)));
        }
        for (int i = 1; i < 21; i+=1) {
            graphics.drawLine((TRIANGLE_SIDE/2+i*TRIANGLE_SIDE/42),(int)(TRIANGLE_BOTTOMY-TRIANGLE_HEIGHT)+ (int)(i*(TRIANGLE_HEIGHT/21)),
                    TRIANGLE_SIDE/2-i*TRIANGLE_SIDE/42, (int)(TRIANGLE_BOTTOMY-TRIANGLE_HEIGHT)+ (int)(i*(TRIANGLE_HEIGHT/21)));
        }
